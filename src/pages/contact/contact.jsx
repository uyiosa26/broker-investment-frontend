...
export default function Contact() {
  return (
    <>
      ...
      />
      <title>Value Trades | Contact us</title>
      ...
      <section className="pb-4 section">
        <div className="container">
          <div className="row">
            ...
            <div className="pt-2 mt-4 col-md-4 mt-sm-0 pt-sm-0">
              <div className="text-center border-0 card features feature-clean">
                <div className="mx-auto text-center icons text-primary">
                  <i className="mb-0 rounded uil uil-envelope d-block h3" />
                </div>
                <div className="mt-3 content">
            ...
            <div className="pt-2 mt-4 col-md-4 mt-sm-0 pt-sm-0">
              <div className="text-center border-0 card features feature-clean">
                <div className="mx-auto text-center icons text-primary">
                  <i className="mb-0 rounded uil uil-map-marker d-block h3" />
                </div>
                <div className="mt-3 content">
        ...
        <div className="container mt-100 mt-60">
          <div className="row align-items-center">
            ...
            <div className="pt-2 col-lg-12 col-md-6 pt-sm-0">
              <div className="border-0 rounded shadow card">
                <div className="py-5 card-body">
                  <h4 className="card-title">Get in Touch !</h4>
                  <div className="mt-4 custom-form">
                    <div id="message" />
                    <form
                      method="post"
                      action="https://valuetrades.online/sendcontact"
                    >
                      <input
                        type="hidden"
                        name="_token"
          ...
          <div className="row">
            ...
            <div className="pt-2 mt-4 col-lg-4 col-md-4 mt-sm-0 pt-sm-0">
              ...
              <div className="mt-2">
                ...
                {/* <p>Valuesfxtrade@gmail.com</p> change support email here */}
              </div>
            </div>
            {/*end col*/}
          </div>
