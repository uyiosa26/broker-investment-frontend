  ...
  return (
    <>
      <>
        ...
        <meta
          itemProp="name"
          content="Value Trades - Welcome to Value Trades"
        />
        ...
        <header id="topnav" className="sticky defaultscroll">
          <div className="container">
            ...
            <div className="buy-button">
              ...
              <Link
                to="/register"
                className="btn btn-primary login-btn-success "
              >
                Get Started
              </Link>
            </div>
                  ...
                  <div className="card-body">
                    ...
                    <div className="mt-4">
                      ...
                      <p className="mt-3 mb-0 text-muted">
                        Value Trade uses the highest levels of Internet
                        Security, and it is secured by 256 bits SSL security
                        encryption to ensure that your information is completely
                ...
                <div className="text-center border-0 rounded card">
                  <div className="card-body">
                    ...
                    <div className="mt-4">
                      ...
                      <p className="mt-3 mb-0 text-muted">
                        Two-factor authentication (2FA) by default on all Value
                        Trade accounts, to securely protect you from
                    ...
                    <div className="pt-4 pb-4 media features">
                      ...
                      <div className="media-body">
                        ...
                        <p className="mb-0 text-muted para">
                          Value Trade offers multiple platform options to cover
                          the needs of each type of trader and investors .
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="pt-4 pb-4 media features">
                      ...
                      <div className="media-body">
                        ...
                        <p className="mb-0 text-muted para">
                          ...
                          with super-low spreads to further up your profits
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-md-6 col-12">
                    <div className="pt-4 pb-4 media features">
                      ...
                      <div className="media-body">
                        ...
                        <p className="mb-0 text-muted para">
                          Super-fast trading software, so you never suffer
                          slippage.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="col-md-6 col-12">
                    <div className="pt-4 pb-4 media features">
                      ...
                      <div className="media-body">
                        ...
                        <p className="mb-0 text-muted para">
                          With advanced security systems, we keep your account
                          always protected.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="col-md-6 col-12">
                    <div className="pt-4 pb-4 media features">
                      ...
                      <div className="media-body">
                        ...
                        <p className="mb-0 text-muted para">
                          Connect with our 24/7 support and Market Analyst
                          on-demand.
                        </p>
                      </div>
                    </div>
              ...
              <div className="pt-2 mt-4 col-lg-6 col-md-6 mt-sm-0 pt-sm-0">
                <div className="section-title ml-lg-5">
                  <h4 className="mb-4 title">
                    Always on the go? Mobile trading is easier than ever with
                    Value Trade!
                  </h4>
                  <p className="text-muted">
                    Get your hands on our customized Trading Platform with the
                    comfort of freely trading on the move, to experience truly
                    liberating trading sessions.
                  </p>
                  <Link
            ...
            <div className="row justify-content-center">
              <div className="text-center col-12">
                <div className="pb-2 mb-4 section-title">
                  ...
                  <p className="mx-auto mb-0 text-muted para-desc">
                    Don't take our word for it, here's what some of our clients
            ...
            <div className="row">
              ...
              <div className="pt-2 mt-4 col-lg-4 col-md-4 mt-sm-0 pt-sm-0">
                ...
                <ul className="mt-4 list-unstyled footer-list">
                  ...
                  <li>
                    <Link
                      to="https://valuetrades.online/faq"
                      className="text-foot"
                    >
                      <i className="mr-1 mdi mdi-chevron-right" />
                      Faq
