                        ...
                        <div className="col-12 col-md-6 col-lg-6 col-sm-10 col-xl-6">
                            ...
                            <div className="bg-white shadow card login-page roundedd border-1 ">
                                <div className="card-body">
                                    ...
                                    <form method="POST" action="https://valuetrades.online/register" className="mt-4 login-form">
                                        <input type="hidden" name="_token" value="KOrGxEGcpVCxXYPvVkB5mwg1aVuLv0Z3wMB3OSSi"/>
                                            <div className="row">
                                                <div className="col-lg-12">
                                                    <div className="form-group">
                                                        ...
                                                        <div className="position-relative">
                                                            ...
                                                            <input type="text" id="input1" className="pl-5 form-control" name="username"
                                                ...
                                                <div className="col-lg-12">
                                                    <div className="form-group">
                                                        ...
                                                        <div className="position-relative">
                                                            ...
                                                            <input type="text" className="pl-5 form-control" name="name" value=""
                                                ...
                                                <div className="col-lg-12">
                                                    <div className="form-group">
                                                        ...
                                                        <div className="position-relative">
                                                            ...
                                                            <input type="phone" className="pl-5 form-control" name="phone" value=""
                                                ...
                                                <div className="col-lg-12">
                                                    <div className="form-group">
                                                        ...
                                                        <div className="position-relative">
                                                            ...
                                                            <input type="password" className="pl-5 form-control"
                                                                name="password_confirmation" value="" id="confirm-password"
                                                ...
                                                <div className="col-lg-12">
                                                    <div className="form-group">
                                                        ...
                                                        <div className="position-relative">
                                                            ...
                                                            <input type="text" className="pl-5 form-control" name="ref_by"
                                                ...
                                                <div className="mb-0 col-lg-12">
                                                    <button className="btn btn-primary btn-block pad" type="submit">Register</button>
                                                </div>
